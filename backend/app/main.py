...
@app.get("/horarios", response_model=List[HorarioDTO])
def listar_horarios_disponiveis(especialidade: str, data: date, repo: ConsultaRepository = Depends(get_consulta_repo)):
