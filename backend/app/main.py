...
from .pdf_service import gerar_pdf_agenda
...
@app.get("/medicos/{medico_id}/agenda/pdf")
def gerar_agenda_pdf(
    medico_id: int,
    data: date,
    solicitante_id: int,
    repo: ConsultaRepository = Depends(get_consulta_repository),
    ...
    agenda = repo.get_agenda_medico_para_pdf(medico_id=medico_id, data=data)
    ...
    return StreamingResponse(
        ...
        headers={
            "Content-Disposition": f"attachment; filename=agenda_{medico_id}_{data}.pdf"
        },
    )
